...
<head>
    ...
    <title>Login - Jawatimur Outdoor</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        /* [CSS Styling dari sebelumnya] */
        ...
        .login-container { background-color: #ffffff; padding: 2.5rem; border-radius: 0.75rem; box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.1); max-width: 400px; width: 100%; text-align: center; }
        .login-container h2 { font-size: 1.5rem; color: #333; margin-bottom: 2rem; }
        ...
        .forgot-password { font-size: 0.9rem; margin-top: 1rem; margin-bottom: 2rem; }
    ...
    <div class="login-container">
        ...
        <form action="{{route('loginStore')}}" method="POST">
            ...
            {{-- <div class="forgot-password text-end">
                <a href="#" class="link-secondary-custom">Lupa Kata Sandi?</a>
            </div> --}}
            <button type="submit" class="btn btn-primary-custom w-100 rounded-pill mb-4 text-white">Masuk</button>
        </form>

        <a href="{{route('onboarding')}}" class="link-secondary-custom d-block mb-3">Kembali</a>

        <p class="register-text">Belum Punya Akun?
            <a href="{{route('register')}}" class="link-secondary-custom fw-bold">Daftar Disini</a>
        </p>
    </div>
